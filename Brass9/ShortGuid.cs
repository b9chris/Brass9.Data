...
namespace Brass9
{
	...
	/// 
	/// Encodes full GUIDs as 22 char values like:
	/// GlUesIPIsEGNTbAgy5Rgjg
	/// ZqahsjUMWEOGd26cOZ1v_A
	/// ZbGQgDFMckWl-xe2ssjYrg
	/// 
	/// Uses Base64 encoding replacing + and / with - and _ to be filename/URL compatible across OSs.
	/// </summary>
	public struct ShortGuid
	{
		...
		#region Validation
		public static bool IsShortGuid(string s)
		{
			var regex = new Regex(@"^[\da-zA-Z_-]{22}$");
